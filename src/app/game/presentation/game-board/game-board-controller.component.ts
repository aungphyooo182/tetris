...
import { GameService } from "src/app/lib/game.service";
import {
  KEY,
  POINTS,
  COLS,
...
import { Piece, IPiece } from "src/app/models/piece.model";
import {
...
@Component({
  ...
  templateUrl: "./game-board-controller.component.html",
  styleUrls: ["./game-board-controller.component.css"],
})
export class GameBoardControllerComponent {
  constructor(
    @Inject(BusinessRequirementsInjectionToken)
    private business: BusinessLogicRequirements,
    private store: GameBoardStore,
